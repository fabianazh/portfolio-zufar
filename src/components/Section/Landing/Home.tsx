            ...
            <section className="w-full flex flex-col gap-3 lg:gap-5 h-fit mb-10">
                ...
                <div className="w-full lg:w-full flex h-fit">
                    <span className="text-base font-base lg:font-medium">
                        Saya lulusan SMK DPIB dengan pengalaman sebagai drafter
                        dan surveyor, serta tersertifikasi dengan berpredikat
                        sangat baik. Mahir dalam perangkat lunak desain, teknik
                        survei, manajemen waktu, komunikasi, dan kerja tim. Siap
                        terus belajar dan berkontribusi di bidang konstruksi.
                    </span>
                </div>
            </section>
        </>
